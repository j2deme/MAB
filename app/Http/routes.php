...
Route::group(['middleware' => 'auth', 'prefix' => 'users', 'as' => 'users.'], function () {
  ...
  Route::get('/activate', 'UserController@uploadActive')->name('uploadActive'); // Form
  Route::post('/enroll', 'UserController@enroll')->name('enroll');
...
Route::group(['middleware' => 'auth', 'prefix' => 'moves', 'as' => 'moves.'], function () {
  ...
  Route::get('/by/subject/{subject}/{all?}', 'MovesController@bySubject')->name('bySubject');
...
Route::group(['middleware' => 'auth', 'prefix' => 'groups', 'as' => 'groups.'], function () {
  ...
  Route::get('/sync', 'GroupController@upload')->name('upload');
  Route::post('/sync', 'GroupController@sync')->name('sync'); // Uses CSV
  Route::post('/load', 'GroupController@load')->name('load'); // Uses TextArea
