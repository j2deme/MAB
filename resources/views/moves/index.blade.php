          ...
          <table class="ui celled striped compact table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="ui center aligned">
                  <small>{{ $item->type }}</small> <i
                    class="ui {{ $item->type == 'ALTA' ? 'blue arrow up' : 'red arrow down' }} icon"></i>
                </td>
                <td class="ui center aligned">
                  @if ($item->is_parallel)
          ...
          <div class="ui card">
            <div class="content">
              ...
              <div class="meta">
                ...
                <span class="category"><small>{{ $item->type }}</small> <i
                    class="ui {{ $item->type == 'ALTA' ? 'blue arrow up' : 'red arrow down' }} icon"></i></span>
              </div>
            </div>
